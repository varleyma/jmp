...
5751 S. Woodlawn Ave.  \hfill \href{mailto:varleym0@chicagobooth.edu}{varleym0@chicagobooth.edu}  \\
Chicago, IL 60637 \hfill \href{https://www.michaelvarley.com}{www.michaelvarley.com}
...
Ph.D. Candidate,
        \href{https://financialeconomics.uchicago.edu/}
             ...
             \hfill 2018-2024 \\
            % Masters of Arts Program in Social Sciences,
...
\section{References}	
	\begin{minipage}[t]{0.6\textwidth}
		\textbf{Amir Sufi} (Chair)\\
		Bruce Lindsay Distinguished Service \\
		Professor of Economics and Public Policy\\
		University of Chicago\\
		Booth School of Business\\
		\href{mailto:amir.sufi@chicagobooth.edu }{amir.sufi@chicagobooth.edu }\\
		(773) 702-6148\\
		
		\textbf{Constantine Yannelis} \\
		Associate Professor of Finance\\
	       	and FMC Faculty Scholar\\
		University of Chicago\\
		Booth School of Business\\
		\href{mailto:constantine.yannelis@chicagobooth.edu }{constantine.yannelis@chicagobooth.edu }\\
		(217) 721-0587\\

		\textbf{Michael Dinerstein} \\
		Assistant Professor of Economics\\
		University of Chicago\\
		Kenneth C. Griffin Department of Economics\\
		\href{mailto:mdinerstein@uchicago.edu}{mdinerstein@uchicago.edu}\\
		(773) 702-8490
	\end{minipage}
	\begin{minipage}[t]{0.6\textwidth}
		\textbf{Pascal Noel}\\
...
\textbf{Household Discount Rates} \\
...
\section{Conferences and Seminars} \textbf{2023}: Amir Sufi's Corporate Finance Reading Group, Chicago Booth Finance Brownbag \\
